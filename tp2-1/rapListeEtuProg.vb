...
Public Class rapListeEtuProg
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "tp2_1.rapListeEtuProg.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrapListeEtuProg
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rapListeEtuProg = New rapListeEtuProg()
        rpt.Site = Me.Site
        Return rpt
    End Function
